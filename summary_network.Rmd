...
c("hcae30e", "h17dd08") |> #, "h8e4929") |>
  purrr::iwalk(\(x, ix) {
    ...
    file_name <- here::here("Results", "summary_reports", glue::glue("summary_{suffix}.md"))
...
print(knitr::kable(coef_results))
```
  ...
  purrr::walk(\(.x) {
    ...
    cat(
      paste0(
        ...
        paste(
          "\"",
          sort(coef_results$coef_name[coef_results[[.x]] > 0]),
          "\"",
          collapse = ", ",
          sep = ""
        ),
