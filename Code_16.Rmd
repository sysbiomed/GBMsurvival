...
best_model_coefficients <- models_coefficients_list[[8]][[best_model_index]] # o index aqui escolhido tem que bater certo com o seed do split data para que dê igual performance
...
ggsave(filename = "Results/riskAUC.pdf", plot = riskAUC$plot, width = 6, height = 4)
...
# write on the chunk end time file
log_chunk_end_time("Analyse the best model", log_file = "chunk_times_log.txt")
```
...
#old <- models_coefficients_list
#models_coefficients_list <- old
#models_coefficients_list <- list(models_coefficients_list[[1]][1])
