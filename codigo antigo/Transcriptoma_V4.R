...
fit <- cv.glmnet(prepareDataForCoxRegression(genes_expression_train),
                 ...
                 alpha = 1.0)  # alpha = 1 for LASSO, 0 for ridge
...
# Fit a Cox regression model using all the covariates)
...
# Calculate C Index, explicação: https://www.youtube.com/watch?v=rRYfWAsG4RI
